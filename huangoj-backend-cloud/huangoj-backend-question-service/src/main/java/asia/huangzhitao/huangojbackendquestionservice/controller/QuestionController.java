package asia.huangzhitao.huangojbackendquestionservice.controller;
...
import asia.huangzhitao.huangojbackendserviceclient.dto.question.*;
...
import asia.huangzhitao.huangojbackendserviceclient.vo.QuestionVO;
...
public class QuestionController {
    ...
    public BaseResponse<Question> getQuestionById(long id, HttpServletRequest request) {
        ...
        User loginUser = userFeignClient.getLoginUser(request);
        if (!question.getId().equals(loginUser.getId()) && !userFeignClient.isAdmin(loginUser)) {
            throw new BusinessException(ErrorCode.NO_AUTH_ERROR);
        }
